...
func authenticatorSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "authenticator.sh", size: 295, mode: os.FileMode(493), modTime: time.Unix(1, 0)}
...
func get_metadataSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "get_metadata.sh", size: 1837, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
